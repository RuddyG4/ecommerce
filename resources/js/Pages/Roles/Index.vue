                        ...
                        <table class="table-auto w-full">
                            <thead class="text-xs font-semibold uppercase text-black bg-gray-50 text-left">
                                <tr class="rounded-tl rounded-tr">
                                    <th class="p-2 whitespace-nowrap rounded-tl">Role name</th>
                            ...
                            <tbody class="text-sm divide-y divide-gray-100">
                                <tr v-for="role in roles" :key="role.id">
                                    <td class="p-2 whitespace-nowrap">{{ role.name }}</td>
                                    <td class="p-2 whitespace-nowrap">{{ role.description }}</td>
                                    <td>
                                        <Link :href="route('roles.show', { role: role.id })" class="bg-blue-200 text-slate-800 font-bold py-1 px-4 rounded mr-2')">
                                        Edit
                                        </Link>
                                    </td>
                                </tr>
