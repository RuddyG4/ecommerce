            ...
            <div class="row property__gallery">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset('storage'). '/'. $product->image_path }}">
                            <div class="label new">New</div>
                            <ul class="product__hover">
                                <li><a href="{{ asset('storage'). '/'. $product->image_path }}" class="image-popup"><span class="arrow_expand"></span></a></li>
